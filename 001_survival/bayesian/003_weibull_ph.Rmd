...
The scale parameter gets modified by the covariates.
...
mcmc_parcoord(post, pars = c("intercept", "beta[1]", "alpha"), np = mpars)

pairs(f2, pars = c("intercept", "beta[1]", "alpha"), las = 1)

mcmc_scatter(post, pars = c("intercept", "alpha"), 
